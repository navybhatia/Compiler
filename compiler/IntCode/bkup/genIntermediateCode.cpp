...
void setNextStateforAll(int curr_state, int val)
{
    for(int j = 0; j< MAX_EVENTS; j++)
        next_location[curr_state][j] = val;
}
...
string RuleNode::generateCode()
{
	...
	string curStateReg =Table.getFreeIntReg();
	string finalStateReg =Table.getFreeIntReg();
